...
def scrape_hourly_candles(market="BTCUSDT", startingDate = dt(2018,1,1)):
    date = startingDate  
    ...
    while i<len(dateList)-1: 
         ...
         print("saved "+str(counter)+"rows of data")
         counter += 1


# scrape_hourly_candles(market="ADAUSDT", startingDate=dt(2020,1,1)) 
