...
def symbol_to_path(symbol, base_dir=None): 
    return ("C:\\Users\\S\\github\\ML4T\\mafi_ML\\data\\future\\1d\\{}.csv".format(str(symbol)))  
...
def get_data(symbols, dates, addSPY=False, colname="Close"):  		  	   		   	 			  		 			     			  	  		 	  	 		 			  		  			
